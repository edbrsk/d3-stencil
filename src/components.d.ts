...
export namespace Components {
  ...
  interface BcgMatrixChart {
    ...
    'updateGraphData': (graphData: Partial<{ pieChart: Partial<{ labelFormat: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; dataFormat: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; currency: string; }>; barChart: Partial<{ axis: Partial<{ x: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; y: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; }>; margin: Partial<{ top: number; right: number; bottom: number; left: number; }>; }>; lineChart: Partial<{ axis: Partial<{ x: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; y: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; }>; margin: Partial<{ top: number; right: number; bottom: number; left: number; }>; }>; lineAnnotationsChart: import("C:/ae/adaept.com/d3-stencil/src/interfaces/charts-options/line-annotations-chart").LineAnnotationsChart; bcgMatrixChart: Partial<{ axis: Partial<{ x: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; y: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; }>; margin: Partial<{ top: number; right: number; bottom: number; left: number; }>; value: Partial<{ format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; currency: string; }>; quadrants: boolean; }>; styles: Partial<{ width: string; height: string; margin: string; padding: string; }>; colors: string[]; labels: number[] | string[]; data: BcgMatrix[]; hasData: import("C:/ae/adaept.com/d3-stencil/src/interfaces/has-data").HasData<unknown>; }>) => void;
  }
  ...
  interface HorizontalBarChart {
    ...
    'updateGraphData': (graphData: Partial<{ pieChart: Partial<{ labelFormat: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; dataFormat: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; currency: string; }>; barChart: Partial<{ axis: Partial<{ x: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; y: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; }>; margin: Partial<{ top: number; right: number; bottom: number; left: number; }>; }>; lineChart: Partial<{ axis: Partial<{ x: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; y: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; }>; margin: Partial<{ top: number; right: number; bottom: number; left: number; }>; }>; lineAnnotationsChart: import("C:/ae/adaept.com/d3-stencil/src/interfaces/charts-options/line-annotations-chart").LineAnnotationsChart; bcgMatrixChart: Partial<{ axis: Partial<{ x: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; y: Partial<{ visible: boolean; gridVisible: boolean; format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; label: string; currency: string; }>; }>; margin: Partial<{ top: number; right: number; bottom: number; left: number; }>; value: Partial<{ format: import("C:/ae/adaept.com/d3-stencil/src/interfaces/index").Formats; currency: string; }>; quadrants: boolean; }>; styles: Partial<{ width: string; height: string; margin: string; padding: string; }>; colors: string[]; labels: number[] | string[]; data: number[]; hasData: import("C:/ae/adaept.com/d3-stencil/src/interfaces/has-data").HasData<unknown>; }>) => void;
  }
